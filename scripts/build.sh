#!/usr/bin/env bash
# Build OrcaSlicer v2.3.2 WASM module and copy artifacts to artifacts/.
#
...
echo ""
echo "✓ Build complete. Artifacts copied to artifacts/:"
ls -lh "../artifacts/slicer."* 2>/dev/null || true
