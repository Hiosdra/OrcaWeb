...
if [[ ! -f artifacts/slicer.js ]] && [[ -f "${BUILDDIR}/slicer.js" ]]; then
  mkdir -p artifacts
  cp "${BUILDDIR}/slicer.js"   artifacts/slicer.js
  cp "${BUILDDIR}/slicer.wasm" artifacts/slicer.wasm
  [[ -f "${BUILDDIR}/slicer.data" ]] && cp "${BUILDDIR}/slicer.data" artifacts/slicer.data
fi

mkdir -p wasm-artifacts
cp artifacts/slicer.js   wasm-artifacts/
cp artifacts/slicer.wasm wasm-artifacts/
[[ -f artifacts/slicer.data ]] && cp artifacts/slicer.data wasm-artifacts/
...
# ══════════════════════════════════════════════════════════
(
node orca-wasm/scripts/smoke-test.mjs --wasm-dir artifacts
)
