 ...
 * "slicer-mt" (build-wasm.yml's mt matrix leg, see orca-wasm/MT-PLAN.md Phase
 * 2). The mt build never produces a plain slicer.js/.wasm alias, so this must
 * be passed explicitly for that variant.
 *
