...
## Voron Design Cube v7 (integration test fixture)

`testdata/voron-design-cube-v7.stl` is a real-world calibration print used as the
fixture for the integration slicing smoke test (see ADR-010).
