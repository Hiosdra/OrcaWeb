...
Clean-room Emscripten build of [OrcaSlicer](https://github.com/SoftFever/OrcaSlicer) v2.4.0 targeting the host.
...
The main deploy workflow (`.github/workflows/deploy.yml`) downloads these artifacts from the `wasm-v2.4.0` release on this repo and embeds them in the artifact mirror deployment under `app/wasm/`, served from the same origin as the app.
