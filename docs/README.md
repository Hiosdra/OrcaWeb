# OrcaWeb — dokumentacja

Dokumentacja postępu projektu. Każdy plik odpowiada jednemu etapowi pracy.

| Plik | Etap | Status |
|------|------|--------|
| [01-research.md](01-research.md) | Research (WASM, API, EasyPrint, profile) | ✅ Ukończony |
| [02-cli-prototype.md](02-cli-prototype.md) | CLI prototype (Node.js + Commander) | ✅ Ukończony |
| [03-web-ui.md](03-web-ui.md) | Web UI (React + Vite + Three.js) | ✅ Ukończony |
